...
<c:if test="${not empty entity}">
  ...
  <button class="btn btn-sm" onclick="getHtmlByAjax('GET', 'entity/?nameRenderer=editEntityJson&nameAction=test&nameEntity=${param.nameEntity}&page=${param.page}&idEntity=${entity.itsId}${flyParams}');">test</button>
</c:if>
