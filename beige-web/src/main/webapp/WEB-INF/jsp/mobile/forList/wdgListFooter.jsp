...
<div class="pages">
  ...
  <button onclick="getHtmlByAjax('GET', 'service/?nmRnd=editEntityJson&nmsAct=entityCreate&nmHnd=${param.nmHnd}&nmEnt=${classEntity.simpleName}&page=${param.page}${flyParams}');" class="btn btn-sm">
    ${srvI18n.getMsg("New")}
  </button>
</div>
