...
<div class="input-line">
  ...
  <input id="${parVal1}" type="datetime-local" ${disabled} required name="${parVal1}" value="${filterMap[parVal1]}" onchange="inputHasBeenChanged(this);">
  ...
  <input id="${parVal2}" type="datetime-local" ${disabled} required name="${parVal2}" value="${filterMap[parVal2]}" onchange="inputHasBeenChanged(this);">
</div>
