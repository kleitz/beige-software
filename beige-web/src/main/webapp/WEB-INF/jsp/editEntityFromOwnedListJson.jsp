...
<c:set var="javascript" value="openDlg('${namePlaceSubForm}EditDlg');"/>
<c:import url="/WEB-INF/jsp/editEntityFromOwnedList.jsp" varReader="rdEditEnty" charEncoding="UTF-8">
{"multiTargetResponse":
