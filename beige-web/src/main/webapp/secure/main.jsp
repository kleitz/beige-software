  ...
  <div class="navbar">
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-content">
         <a href="#" onclick="getHtmlByAjax('GET', 'entityList/?nameRenderer=listWholeJson&nameEntity=PersistableHead&page=1');">${pageContext.servletContext.getAttribute("srvI18n").getMsg("PersistableHeads")}</a>
         <a href="#" onclick="getHtmlByAjax('GET', 'entityList/?nameRenderer=listWholeJson&nameEntity=Department&page=1');">${pageContext.servletContext.getAttribute("srvI18n").getMsg("Departments")}</a>
         <a href="#" onclick="getHtmlByAjax('GET', 'entityList/?nameRenderer=listWholeJson&nameEntity=GoodVersionTime&page=1');">${pageContext.servletContext.getAttribute("srvI18n").getMsg("GoodVersionTimes")}</a>
      </div>
    </div>
    <div class="nav-right">
