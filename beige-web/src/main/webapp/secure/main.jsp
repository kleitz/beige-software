  ...
  <div class="navbar">
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-content">
        <a href="#" onclick="getHtmlByAjax('GET', 'service/?nmHnd=handlerEntityRequest&nmsAct=list&nmRnd=listWholeJson&nmEnt=PersistableHead&page=1');">${pageContext.servletContext.getAttribute("srvI18n").getMsg("PersistableHeads")}</a>
        <a href="#" onclick="getHtmlByAjax('GET', 'service/?nmHnd=handlerEntityRequest&nmsAct=list&nmRnd=listWholeJson&nmEnt=Department&page=1');">${pageContext.servletContext.getAttribute("srvI18n").getMsg("Departments")}</a>
        <a href="#" onclick="getHtmlByAjax('GET', 'service/?nmHnd=handlerEntityRequest&nmsAct=list&nmRnd=listWholeJson&nmEnt=GoodVersionTime&page=1');">${pageContext.servletContext.getAttribute("srvI18n").getMsg("GoodVersionTimes")}</a>
        ...
        <a href="#" onclick="getHtmlByAjax('GET', 'service/?nmHnd=handlerEntityRequest&nmsAct=list&nmRnd=listWholeJson&nmEnt=UserTomcat&page=1');">${pageContext.servletContext.getAttribute("srvI18n").getMsg("UserTomcats")}</a>
        <a href="#" onclick="getHtmlByAjax('GET', 'service/?nmHnd=handlerEntityRequest&nmsAct=list&nmRnd=listWholeJson&nmEnt=UserRoleTomcat&page=1');">${pageContext.servletContext.getAttribute("srvI18n").getMsg("UserRoleTomcats")}</a>
        <a href="#" onclick="getHtmlByAjax('GET', 'service/?nmHnd=handlerEntityRequest&nmsAct=list&nmRnd=listWholeJson&nmEnt=UserRoleTomcatPriority&page=1');">${pageContext.servletContext.getAttribute("srvI18n").getMsg("UserRoleTomcatPrioritys")}</a>
        <a href="#" onclick="getHtmlByAjax('GET', 'service/?nmHnd=handlerEntityRequest&nmsAct=list&nmRnd=listWholeJson&nmEnt=UserJetty&page=1');">${pageContext.servletContext.getAttribute("srvI18n").getMsg("UserJettys")}</a>
        <a href="#" onclick="getHtmlByAjax('GET', 'service/?nmHnd=handlerEntityRequest&nmsAct=list&nmRnd=listWholeJson&nmEnt=RoleJetty&page=1');">${pageContext.servletContext.getAttribute("srvI18n").getMsg("RoleJettys")}</a>
        <a href="#" onclick="getHtmlByAjax('GET', 'service/?nmHnd=handlerEntityRequest&nmsAct=list&nmRnd=listWholeJson&nmEnt=UserRoleJetty&page=1');">${pageContext.servletContext.getAttribute("srvI18n").getMsg("UserRoleJettys")}</a>
