...
/**
 * <pre>Base abstraction persistable model with name and Version.</pre>
 *
 * @author Yury Demidenko
 */
public abstract class APersistableBaseNameVersion
  extends APersistableBaseVersion  implements IHasName {
