...
/**
 * <p>
 * WarehouseRests servlet.
 * </p>
 *
 * @author Yury Demidenko
 */
@SuppressWarnings("serial")
public class WWarehouseRests extends HttpServlet {
  ...
  public final void doGet(final HttpServletRequest pReq,
    ...
    try {
      ...
      List<WarehouseRestLine> warehouseRestsLines = null;
      try {
        srvDatabase.setIsAutocommit(false);
        srvDatabase.
          setTransactionIsolation(ISrvDatabase.TRANSACTION_READ_UNCOMMITTED);
        srvDatabase.beginTransaction();
        warehouseRestsLines = srvWarehouseRests
          .retrieveWarehouseRests(addParams);
