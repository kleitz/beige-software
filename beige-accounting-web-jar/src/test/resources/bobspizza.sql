...
insert into DEBTORCREDITOR (ITSID, ITSVERSION, ITSNAME, ITSCATEGORY, ITSPHONE, ITSADDRESS) values (15626875423, 1462867334713, 'Carlo''s grocery', 2, '+1 562 687 54 23', 'Grove st.1');
insert into DEBTORCREDITOR (ITSID, ITSVERSION, ITSNAME, ITSCATEGORY, ITSPHONE, ITSADDRESS) values (15626171411, 1462867334713, 'Seven Eleven', 1, '+1 562 617 14 11', 'Mice st.4');
insert into DEBTORCREDITOR (ITSID, ITSVERSION, ITSNAME, ITSCATEGORY, ITSPHONE, ITSADDRESS) values (91191191101, 1462867334713, 'Funny coffe shop', 1, '?', '?');
