...
insert into DEBTORCREDITOR (ITSID, ITSVERSION, ITSNAME, ITSCATEGORY, REGPHONE, REGADDRESS1) values (15626171411, 1462867334713, 'Seven Eleven', 1, '+1 562 617 14 11', 'Mice st.4');
insert into DEBTORCREDITOR (ITSID, ITSVERSION, ITSNAME, ITSCATEGORY, REGPHONE, REGADDRESS1) values (91191191101, 1462867334713, 'Funny coffe shop', 1, '?', '?');
