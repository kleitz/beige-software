...
<c:set var="nameEnts" value="AccountingEntrys"/>
...
<div class="pages">
  <button onclick="getHtmlByAjaxCareful('GET', 'service/?nmHnd=${param.nmHnd}&nmRnd=editEntityFolJson&nmsAct=entityCreate&nmEnt=AccountingEntry&AccountingEntry.sourceId=${ownerIdStr}${ownerVersion}${flyParams}');" class="btn btn-sm">
    ${srvI18n.getMsg("New")}
  </button>
</div>
