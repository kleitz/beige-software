...
<tr>
  <td>
    <div class="input-line">
      ...
      <button type="button" class="btn" onclick="openEntityPicker('${srvOrm.tablesMap[entity.getClass().simpleName].fieldsMap[fieldName].foreignEntity}','${entity.getClass().simpleName}', '${fieldName}', '&fltordPhasMadeAccEntriesVal=true&fltordPtheRestVal1=0&fltordPtheRestOpr1=gt&fltordPforcedFor=hasMadeAccEntries%2CtheRest&mobile=${param.mobile}');">...</button>
