...
<tr>
  <td>
    <div class="input-line">
      <input type="number" step="${stepq}" required id="${entity.getClass().simpleName}itsQuantity" name="${entity.getClass().simpleName}.itsQuantity" value="${entity['itsQuantity']}" onchange="inputHasBeenChanged(this); calculatePrice('${entity.getClass().simpleName}');"/> 
    </div>
  </td>
</tr>
