...
<head>
  ...
  <title>${srvI18n.getMsg("warehouse_site_rests")} <fmt:formatDate value="${now}" type="both" timeStyle="short"/></title>
</head>
<body>
  <div style="text-align: center;">
    <h4>
      ${srvI18n.getMsg("warehouse_site_rests")} <fmt:formatDate value="${now}" type="both" timeStyle="short"/> <br>
