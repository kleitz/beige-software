...
<div class="form-actions">
  ...
  <button type="button" onclick="if (confirm(MSGS['are_you_sure'])) submitFormByAjax('${namePlaceForm}EditFrm', false, '&nameRenderer=editEntitySavedJson&actionAdd=fill');">${srvI18n.getMsg("fill_taxes")}</button>
