...
<div class="form-actions">
  ...
  <button type="button" onclick="submitFormByAjaxConfirm('${namePlaceForm}EditFrm', false, '&nameRenderer=editEntitySavedJson&actionAdd=fill');">${srvI18n.getMsg("fill_taxes")}</button>
