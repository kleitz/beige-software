...
<div class="form-actions">
  ...
  <button type="button" onclick="submitFormByAjaxConfirm('${namePlaceForm}EditFrm', false, '&nmRnd=editEntitySavedJson&actionAdd=fill');">${srvI18n.getMsg("fill_taxes")}</button>
