...
<tr>
  ...
  <td>
    <div class="input-line">
      ...
      <button type="button" class="btn" onclick="openEntityPicker('CatalogGs','${entity.getClass().simpleName}', '${fieldName}','&nmHnd=${param.nmHnd}&fltordPhasSubcatalogsVal=false&fltordPforcedFor=hasSubcatalogs');">...</button>
