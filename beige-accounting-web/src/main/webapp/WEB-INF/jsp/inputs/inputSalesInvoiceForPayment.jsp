...
<tr>
  ...
  <td>
    <div class="input-line">
      ...
      <button type="button" class="btn" onclick="openEntityPicker('${srvOrm.tablesMap[entity.getClass().simpleName].fieldsMap[fieldName].foreignEntity}','${entity.getClass().simpleName}', '${fieldName}', '&fltordPhasMadeAccEntriesVal=true&fltordPpaymentTotalVal1=SALESINVOICE.ITSTOTAL&fltordPpaymentTotalOpr1=lt&fltordPforcedFor=hasMadeAccEntries%2CpaymentTotal&mobile=${param.mobile}');">...</button>
