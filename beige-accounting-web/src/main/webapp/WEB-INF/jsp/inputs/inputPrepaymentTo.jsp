...
<tr>
  ...
  <td>
    <div class="input-line">
      ...
      <button type="button" class="btn" onclick="openEntityPicker('${srvOrm.tablesMap[entity.getClass().simpleName].fieldsMap[fieldName].foreignEntity}','${entity.getClass().simpleName}', '${fieldName}', '&fltordPhasMadeAccEntriesVal=true&fltordPpurchaseInvoiceIdOpr1=isnull&fltordPforcedFor=hasMadeAccEntries%2CpurchaseInvoiceId&mobile=${param.mobile}');">...</button>
