...
<a href="reportPdf/?nmHnd=hndlEntityFileReportReq&reporterNm=InvoiceReportPdf&nmEnt=${classEntity.simpleName}&${classEntity.simpleName}.${objectIdName}=${entityIdStr}" target="_blank" class="btn btn-sm" >${srvI18n.getMsg("Print")}</a>
