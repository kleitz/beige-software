  ...
  <div class="navbar">
    <div class="dropdown">
      ...
      <div class="dropdown-content">
         ...
         <a href="#" onclick="getHtmlByAjax('GET', 'entityList/?nameRenderer=listWholeJson&nameEntity=ServiceToSaleCategory&page=1&mobile=mobile%2F');">${pageContext.servletContext.getAttribute("srvI18n").getMsg("ServiceToSaleCategorys")}</a>
         <a href="#" onclick="getHtmlByAjax('GET', 'entityList/?nameRenderer=listWholeJson&nameEntity=ServiceToSale&page=1&mobile=mobile%2F');">${pageContext.servletContext.getAttribute("srvI18n").getMsg("ServiceToSales")}</a>
