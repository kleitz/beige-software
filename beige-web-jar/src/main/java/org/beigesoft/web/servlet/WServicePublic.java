 ...
 * This is public service, so it checks whether user request public.
 * For example webstore requests for buyers are public, but webstore-admin
 * and webstore-seseller requests are secured.
 * </p>
 *
 * @author Yury Demidenko
 */
@SuppressWarnings("serial")
public class WServicePublic extends HttpServlet {
  ...
  public final void init() throws ServletException {
    ...
    try {
      ...
      if (this.factoryAppBeans == null) {
        ...
        initFactory.makeWith(new FactoryAndServlet(this.factoryAppBeans, this));
      }
    } catch (Exception e) {
      if (this.factoryAppBeans != null) {
        ILogger logger = null;
  ...
  public final void doWork(final HttpServletRequest pReq,
    ...
    try {
      @SuppressWarnings("unchecked")
      IDelegateEvaluate<HttpServletRequest, Boolean> checkerPublic =
        (IDelegateEvaluate<HttpServletRequest, Boolean>) this.factoryAppBeans
          .lazyGet("checkerPublic");
      if (!checkerPublic.evaluate(pReq)) {
