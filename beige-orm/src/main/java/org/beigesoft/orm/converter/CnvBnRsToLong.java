...
/**
 * <p>Converter field from JDBC result-set to Long.</p>
 *
 * @param <RS> platform dependent record set type
 * @author Yury Demidenko
 */
public class CnvBnRsToLong<RS> implements
  IConverterByName<IRecordSet<RS>, Long> {
   ...
   **/
  @Override
  public final Long convert(final Map<String, Object> pAddParam,
