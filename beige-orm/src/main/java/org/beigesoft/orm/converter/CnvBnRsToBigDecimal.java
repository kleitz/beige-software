...
/**
 * <p>Converter field from JDBC result-set to BigDecimal.</p>
 *
 * @param <RS> platform dependent record set type
 * @author Yury Demidenko
 */
public class CnvBnRsToBigDecimal<RS> implements
  IConverterByName<IRecordSet<RS>, BigDecimal> {
   ...
   **/
  @Override
  public final BigDecimal convert(final Map<String, Object> pAddParam,
    final IRecordSet<RS> pFrom, final String pName) throws Exception {
    Double doubleVal = pFrom.getDouble(pName);
    if (doubleVal != null) {
