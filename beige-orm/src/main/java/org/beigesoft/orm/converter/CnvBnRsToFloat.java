...
/**
 * <p>Converter field from JDBC result-set to Float.</p>
 *
 * @param <RS> platform dependent record set type
 * @author Yury Demidenko
 */
public class CnvBnRsToFloat<RS> implements
  IConverterByName<IRecordSet<RS>, Float> {
   ...
   **/
  @Override
  public final Float convert(final Map<String, Object> pAddParam,
    final IRecordSet<RS> pFrom, final String pName) throws Exception {
    return pFrom.getFloat(pName);
  }
}
