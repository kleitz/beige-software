...
/**
 * <p>Converter field from JDBC result-set to String.</p>
 *
 * @param <RS> platform dependent record set type
 * @author Yury Demidenko
 */
public class CnvBnRsToString<RS> implements
  IConverterByName<IRecordSet<RS>, String> {
   ...
   **/
  @Override
  public final String convert(final Map<String, Object> pAddParam,
    final IRecordSet<RS> pFrom, final String pName) throws Exception {
    return pFrom.getString(pName);
  }
}
