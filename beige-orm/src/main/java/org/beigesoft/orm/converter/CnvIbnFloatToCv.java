...
/**
 * <p>Converter from a Float type to ColumnsValues
 * without transformation.</p>
 *
 * @author Yury Demidenko
 */
public class CnvIbnFloatToCv
  implements IConverterIntoByName<Float, ColumnsValues> {

  /**
   * <p>Put Float object to ColumnsValues without transformation.</p>
  ...
  public final void convert(final Map<String, Object> pAddParam,
    final Float pFrom, final ColumnsValues pTo,
