...
/**
 * <p>Converter field from JDBC result-set to Enum.</p>
 *
 * @param <RS> platform dependent record set type
 * @author Yury Demidenko
 */
public class CnvBnRsToEnum<RS> implements
  IConverterByName<IRecordSet<RS>, Enum> {
   ...
   **/
  @Override
  public final Enum convert(final Map<String, Object> pAddParam,
    final IRecordSet<RS> pFrom, final String pName) throws Exception {
    Integer intVal = pFrom.getInteger(pName);
    if (intVal != null) {
      Class fieldClass = (Class) pAddParam.get("fieldClass");
      return (Enum) fieldClass.getEnumConstants()[intVal];
    }
    return null;
  }
}
