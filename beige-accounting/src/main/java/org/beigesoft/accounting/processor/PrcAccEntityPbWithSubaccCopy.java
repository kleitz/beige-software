 ...
 * Those entities are AdditionCostLine.</p>
 *
 * @param <RS> platform dependent record set type
 * @param <T> entity type
 * @author Yury Demidenko
 */
public class PrcAccEntityPbWithSubaccCopy<RS, T extends IPersistableBase>
  ...
  public final T process(
    ...
    return this.prcAccEntityPbCopy.process(pAddParam, pEntity, pRequestData);
  }
